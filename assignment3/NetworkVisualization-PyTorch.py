...
#    https://colab.research.google.com/drive/1xNQ_qVa4fb-fW8A-keFiVB6W0RImpwpz
#
...
plt.savefig('q3a_NetworkVis_SampleImages.png', bbox_inches='tight', dpi=250)
...
def show_saliency_maps(X, y):
    ...
    plt.savefig('q3b_NetworkVis_SaliencyMaps.png', bbox_inches='tight', dpi=250)
...
plt.gcf().set_size_inches(12, 5)
plt.savefig('q3c_NetworkVis_FoolingImages.png', bbox_inches='tight', dpi=250)
...
def create_class_visualization(target_y, model, dtype, **kwargs):
    ...
    for t in range(num_iterations):
        ...
        if t == 0 or (t + 1) % show_every == 0 or t == num_iterations - 1:
            ...
            plt.axis('off')
            plt.savefig('q3d_NetworkVis_ClassVis_Hourglass_Iter' + str(t)+'of'+str(num_iterations) + '.png', bbox_inches='tight', dpi=250)
